...
desenvolvimento de \textit{bots}, a Seção \ref{sec:trab-rel} apresenta trabalhos
relacionados, e finalmente, a Seção \ref{sec:objetivos} delineia os objetivos
específicos deste trabalho com base nos conceitos apresentados.
