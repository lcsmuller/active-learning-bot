...
Sistema: Aula iniciada. Os alunos podem acessar o canal de vídeo usando o código
         de acesso enviado em sua mensagem privada.
...
[Vários alunos entram no canal de vídeo]
...
```
Para testar este código, utilize /executar
