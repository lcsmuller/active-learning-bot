...
% título
\title{Bot Educacional para Facilitação de Metodologias Ativas no Ensino Remoto: Uma Abordagem de Interação Natural em Ambientes Virtuais}

% palavras-chave e keywords (p/ resumo, abstract e metadados do PDF)
\pchave{Bots educacionais. Metodologias ativas. Ensino remoto. Interações mediadas. Feedback em tempo real.}
\keyword{Educational bots. Active methodologies. Remote teaching. Mediated interactions. Real-time feedback.}

% autoria
\author{Lucas Müller}
\advisor{Bruno Müller}
...
\include{3-proposta/texto}		% proposta
\include{4-valida/texto}		% experimentação e validação
