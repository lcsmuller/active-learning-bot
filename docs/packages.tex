...
\lstset{literate={á}{{\'a}}1  {ã}{{\~a}}1 {à}{{\`a}}1 {â}{{\^a}}1
                 ...
                 {ú}{{\'u}}1  {Ú}{{\'U}}1
                 {ç}{{\c{c}}}1 {Ç}{{\c{C}}}1 }
\lstset{escapeinside={(*@}{@*)}} % permite usar comandos LaTeX dentro do código
...
\usepackage[numbers,sort&compress]{natbib} % Carrega natbib com suporte a números e agrupamento (ex: [1-3] )
